@extends('layouts.app') @section('title', '商品管理') @section('style')
<link rel="stylesheet" href="{{ asset('css/goods.css') }}"> @endsection @section('page', '商品管理') @section('container')
<div class="row">
    <div class="col">
                    ...
                    <form action="{{ route('goods.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row col-lg-10">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control" type="number" step="1" name="sale" id="sale">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input class="form-control" type="number" step="1" name="surplus" id="surplus">
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
